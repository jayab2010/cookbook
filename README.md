...
Cookbook is a recipe management site that allows users to create, share, and store recipes. COOKBOOK was created using mongodb, a python web framework and several django plugins. Some of the features of Cookbook are;
